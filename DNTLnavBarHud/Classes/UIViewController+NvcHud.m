...
- (void)testFromNib:(NSString *)text {
    ...
    NSBundle *podBundle = [NSBundle bundleForClass:[NvcTitleAndHud class]];
    id data = [podBundle URLForResource:@"DNTLnavBarHud" withExtension:@"bundle"];
    ...
    NvcTitleAndHud *finish = [bundle loadNibNamed:@"NvcTitleAndHud" owner:nil options:nil].firstObject;
                              //alloc] ini initWithNibName:@"NvcTitleAndHud" bundle:bundle];
